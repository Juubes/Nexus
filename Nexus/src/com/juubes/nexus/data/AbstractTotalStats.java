...
//	kills, deaths, monuments, wins, losses, winTime, lossTime, biggestKillStreak;
	...
	protected final HashMap<Integer, AbstractStats> allStats;
	protected final UUID uuid;

	public AbstractTotalStats(UUID uuid, HashMap<Integer, AbstractStats> allStats) {
		this.uuid = uuid;
	...
	public HashMap<Integer, AbstractStats> getAllStats() {
		return allStats;
	}
}

...
public class Team {
    ...
    /**
     * @param ID          is the 'short name' for the team as identified in the config
     *                    files.
     * @param displayName is the display name for the team - without color
     * @param teamColor   give the color
     */

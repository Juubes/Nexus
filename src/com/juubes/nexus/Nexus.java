...
public class Nexus extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLang().loadTranslations(getResource("lang.yml"));
    ...
    /**
     * Saves the config to a custom folder instead of ./plugins/Nexus/
     */
    @Override
    ...
    public FileConfiguration getConfig() {
        if (this.nexusConfig == null)
            this.nexusConfig = YamlConfiguration.loadConfiguration(new File(this.getConfigFolder(), "config.yml"));
        return nexusConfig;
    }

    public File getConfigFolder() {
//      return new File(options.getNexusConfigFolder());
